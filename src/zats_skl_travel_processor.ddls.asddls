...
define root view entity ZATS_SKL_TRAVEL_PROCESSOR
  ...
  as projection on ZATS_SKL_TRAVEL
{
  ...
  key     TravelId,
          ...
          /* Associations */
          _Agency,
          _Booking : redirected to composition child ZATS_SKL_BOOKING_PROCESSOR,
          _Currency,
          _Customer,
          _OverallStatus,
          _Attachment: redirected to composition child ZATS_SKL_M_ATTACH_PROCESSOR,
