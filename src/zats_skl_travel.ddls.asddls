...
define root view entity ZATS_SKL_TRAVEL
  as select from /dmo/travel_m
  --Composition child for travel viz booking
  composition [0..*] of ZATS_SKL_BOOKING         as _Booking
  --associations -loose coupling to get dependant data
  composition [0..*] of zats_skl_m_attach         as _Attachment
