CLASS lhc_Travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    ...
    TYPES: tt_travel_failed   TYPE TABLE FOR FAILED zats_skl_u_travel,
           tt_travel_reported TYPE TABLE FOR REPORTED zats_skl_u_travel.
...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD update.
    ...
    LOOP AT entities ASSIGNING FIELD-SYMBOL(<travel_update>).
      ""Step 2: Get the incoming data in a structure which our legacy code understand
      ""USING CONTROL addition will bring only modified values. CONTROL structure is mentioned in BDEF
...
CLASS lsc_ZATS_SKL_U_TRAVEL DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PROTECTED SECTION.
...
CLASS lsc_ZATS_SKL_U_TRAVEL IMPLEMENTATION.
