...
define root view entity ZATS_SKL_U_TRAVEL
  ...
  association [1] to ZATS_XX_U_AGENCY        as _Agency       on $projection.AgencyId = _Agency.AgencyId
  association [1] to ZATS_XX_U_CUSTOMER      as _Customer     on $projection.CustomerId = _Customer.CustomerId
